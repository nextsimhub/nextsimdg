...
public:
    ...
    inline double& evaporationRate() { return m_evap; };
    //! Rate of sublimation ice to vapour [kg s⁻¹ m⁻²]
    inline double& sublimationRate() { return m_subl; }
    ...
    inline double& QOpenWater() { return m_Qow; }
    //! Ocean to atmosphere longwave heat flux over open water [W m⁻²]
    inline double& QLongwaveOpenWater() { return m_Qlwow; }
    //! Ocean to atmosphere longwave heat flux over open water [W m⁻²]
    inline double& QShortwaveOpenWater() { return m_Qswow; }
    //! Ocean to atmosphere longwave heat flux over open water [W m⁻²]
    inline double& QLatentHeatOpenWater() { return m_Qlhow; }
    //! Ocean to atmosphere longwave heat flux over open water [W m⁻²]
    inline double& QSensibleHeatOpenWater() { return m_Qshow; }

    //! Total heat flux over ice [W m⁻²]
    inline double& QIce() { return m_Qi; }
    //! Ocean to atmosphere longwave heat flux over ice [W m⁻²]
    inline double& QLongwaveIce() { return m_Qlwi; }
    //! Ocean to atmosphere longwave heat flux over ice [W m⁻²]
    inline double& QShortwaveIce() { return m_Qswi; }
    //! Ocean to atmosphere longwave heat flux over ice [W m⁻²]
    inline double& QLatentHeatIce() { return m_Qlhi; }
    //! Ocean to atmosphere longwave heat flux over ice [W m⁻²]
    inline double& QSensibleHeatIce() { return m_Qshi; }
    //! Derivative of ice-atmosphere heat flux with respect to ice surface temperature [W m⁻² K⁻¹]
    inline double& QDerivativeWRTTemperature() { return m_dQ_dT; }
