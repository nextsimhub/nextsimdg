...
void NextsimPhysics::calculate(const PrognosticData& prog, const ExternalData& exter, PhysicsData& phys)
{
...
void NextsimPhysics::massFluxIceOcean(const PrognosticData& prog, const ExternalData& exter,
    PhysicsData& phys)
{
