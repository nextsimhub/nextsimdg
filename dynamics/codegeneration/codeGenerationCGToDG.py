...
def cg2dg_matrix(dg, cg):
    ...
    if dg > 1:
        print(
            "static const Eigen::Matrix<double, {0}, {1}, Eigen::RowMajor> CG{2}_to_DG{3} =".format(
        ...
        print(
            "static const Eigen::Matrix<double, {0}, {1}> CG{2}_to_DG{3} =".format(
                dg, bf.cgdofs(cg), cg, dg
            )
        )
...
def cg2dg_dxy_matrix(dg, cg, dXY):
    ...
    if dg > 1:
        print(
            "static const Eigen::Matrix<double, {0}, {1}, Eigen::RowMajor> CG{2}_to_DG{3}_d{4} =".format(
        ...
        print(
            "static const Eigen::Matrix<double, {0}, {1}> CG{2}_to_DG{3}_d{4} =".format(
                dg, bf.cgdofs(cg), cg, dg, dXY
            )
        )
        print("\t(Eigen::Matrix<double, {0}, {1}>() <<".format(dg, bf.cgdofs(cg)))
...
def dg_cg_dxy_matrix(dg, cg, dXY):
    ...
    if dg > 1:
        print(
            "static const Eigen::Matrix<double, {0}, {1}, Eigen::RowMajor> DG{2}_CG{3}_d{4} =".format(
        ...
        print(
            "static const Eigen::Matrix<double, {0}, {1}> DG{2}_CG{3}_d{4} =".format(
                bf.cgdofs(cg), dg, dg, cg, dXY
            )
        )
