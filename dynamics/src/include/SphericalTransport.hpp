/*!
 * @file    SphericalTransport.hpp
 * @date    Dec 5, 2022
 * @author  Thomas Richter <thomas.richter@ovgu.de>
 */

#ifndef __SPHERICALTRANSPORT_HPP
#define __SPHERICALTRANSPORT_HPP
...
public:
        ...
        , timesteppingscheme("rk2")
    {
        if (!(smesh.nelements > 0)) {
            std::cerr << "SphericalTransport: The mesh must already be initialized!" << std::endl;
            abort();
        }
...
#endif /* __SPHERICALTRANSPORT_HPP */
