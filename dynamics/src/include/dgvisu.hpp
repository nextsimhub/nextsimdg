...
public:
    ...
    static void write_cgvector(const std::string& fname,
        const CGVector<1>& v,
        const Mesh& mesh)
    {
        ...
        const Mesh& mesh)
    {
        ...
        OUT << "# vtk DataFile Version 2.0" << std::endl
            ...
            << "ASCII" << std::endl
            << "DATASET STRUCTURED_POINTS" << std::endl
            << "DIMENSIONS " << 2 * mesh.nx + 1 << " " << 2 * mesh.ny + 1 << " 1"
            << std::endl
            << "ORIGIN 0 0 0" << std::endl
    ...
    static void write_cg(const std::string& fname,
        int n,
        const CGVector<CGdegree>& v,
        const Mesh& mesh)
    {
