...
public:
    ...
    template <int DG>
    static void write_dg(const std::string& fname, const CellVector<DG>& v, const ParametricMesh& smesh)
    {
        // extract variable name
        std::string variableName
            = fname.substr(fname.find("/") + 1, fname.find_first_of(".") - fname.find("/") - 1);
    ...
    static void write_dg(const std::string& fname, const CellVector<6>& v, const ParametricMesh& smesh)
    {
        // extract variable name
        std::string variableName
            = fname.substr(fname.find("/") + 1, fname.find_first_of(".") - fname.find("/") - 1);
    ...
    template <int DG>
    static void write_dg(
        const std::string& fname, int n, const CellVector<DG>& v, const ParametricMesh& smesh)
    {
