...
private:
    ...
    void stressTensorEdgesY(double scaleSigma, size_t c1, size_t c2)
    {
        ...
        const LocalEdgeVector<1> S11right(S11(c2, 0) - 0.5 * S11(c2, 1), S11(c2, 2));
        const LocalEdgeVector<1> S12left(S12(c1, 0) + 0.5 * S12(c1, 1), S12(c1, 2));
        const LocalEdgeVector<1> S12right(S12(c2, 0) - 0.5 * S12(c2, 1), S12(c2, 2));
    ...
    void stressTensorEdgesX(double scaleSigma, size_t c1, size_t c2)
    {
        ...
        const LocalEdgeVector<1> S12top(S12(c2, 0) - 0.5 * S12(c2, 2), S12(c2, 1));
        const LocalEdgeVector<1> S22bot(S22(c1, 0) + 0.5 * S22(c1, 2), S22(c1, 1));
        const LocalEdgeVector<1> S22top(S22(c2, 0) - 0.5 * S22(c2, 2), S22(c2, 1));
    ...
    void stressTensorBoundaryLeft(double scaleSigma, size_t c)
    {
        ...
        const LocalEdgeVector<1> S12left(S12(c, 0) - 0.5 * S12(c, 1), S12(c, 2));
    ...
    {
        const LocalEdgeVector<1> S11right(S11(c, 0) + 0.5 * S11(c, 1), S11(c, 2));
        const LocalEdgeVector<1> S12right(S12(c, 0) + 0.5 * S12(c, 1), S12(c, 2));
    ...
    {
        const LocalEdgeVector<1> S12top(S12(c, 0) + 0.5 * S12(c, 2), S12(c, 1));
        const LocalEdgeVector<1> S22top(S22(c, 0) + 0.5 * S22(c, 2), S22(c, 1));
    ...
    {
        const LocalEdgeVector<1> S12bot(S12(c, 0) - 0.5 * S12(c, 2), S12(c, 1));
        const LocalEdgeVector<1> S22bot(S22(c, 0) - 0.5 * S22(c, 2), S22(c, 1));
...
private:
    ...
    {
        const LocalEdgeVector<2> topX(vx(c1, 0) + 0.5 * vx(c1, 2) + 1. / 6. * vx(c1, 4),
            vx(c1, 1) + 0.5 * vx(c1, 5), vx(c1, 3));
        const LocalEdgeVector<2> bottomX(vx(c2, 0) - 0.5 * vx(c2, 2) + 1. / 6. * vx(c2, 4),
            vx(c2, 1) - 0.5 * vx(c2, 5), vx(c2, 3));

        const LocalEdgeVector<2> topY(vy(c1, 0) + 0.5 * vy(c1, 2) + 1. / 6. * vy(c1, 4),
            vy(c1, 1) + 0.5 * vy(c1, 5), vy(c1, 3));
        const LocalEdgeVector<2> bottomY(vy(c2, 0) - 0.5 * vy(c2, 2) + 1. / 6. * vy(c2, 4),
