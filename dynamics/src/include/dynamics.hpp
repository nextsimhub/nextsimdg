...
private:
    ...
    void stressTensorEdgesY(double scaleSigma, size_t c1, size_t c2)
    {
        const LocalEdgeVector<1> S11left( // left/right refers to the element
            S11(c1, 0) + sqrt(3.0) * S11(c1, 1),
            S11(c1, 2));
        const LocalEdgeVector<1> S11right(
            S11(c2, 0) - sqrt(3.0) * S11(c2, 1),
            S11(c2, 2));
        const LocalEdgeVector<1> S12left(
            S12(c1, 0) + sqrt(3.0) * S12(c1, 1),
            S12(c1, 2));
        const LocalEdgeVector<1> S12right(
            S12(c2, 0) - sqrt(3.0) * S12(c2, 1),
            S12(c2, 2));
    ...
    void stressTensorEdgesX(double scaleSigma, size_t c1, size_t c2)
    {
        const LocalEdgeVector<1> S12bot( // bot/top refers to the element
            S12(c1, 0) + sqrt(3.0) * S12(c1, 2),
            S12(c1, 1));
        const LocalEdgeVector<1> S12top(
            S12(c2, 0) - sqrt(3.0) * S12(c2, 2),
            S12(c2, 1));
        const LocalEdgeVector<1> S22bot(
            S22(c1, 0) + sqrt(3.0) * S22(c1, 2),
            S22(c1, 1));
        const LocalEdgeVector<1> S22top(
            S22(c2, 0) - sqrt(3.0) * S22(c2, 2),
            S22(c2, 1));
    ...
    void stressTensorBoundaryLeft(double scaleSigma, size_t c)
    {
        const LocalEdgeVector<1> S11left( // left edge of the element
            S11(c, 0) - sqrt(3.0) * S11(c, 1),
            S11(c, 2));
        const LocalEdgeVector<1> S12left(
            S12(c, 0) - sqrt(3.0) * S12(c, 1),
            S12(c, 2));
    ...
    {
        const LocalEdgeVector<1> S12top(
            S12(c, 0) + sqrt(3.0) * S12(c, 2),
            S12(c, 1));
        const LocalEdgeVector<1> S22top(
            S22(c, 0) + sqrt(3.0) * S22(c, 2),
            S22(c, 1));
...
private:
    ...
    {
        const LocalEdgeVector<2> leftX(vx(c1, 0) + sqrt(3.0) * vx(c1, 1) + sqrt(5.0) * vx(c1, 3),
            vx(c1, 2) + sqrt(3.0) * vx(c1, 5),
            vx(c1, 4));
        const LocalEdgeVector<2> leftY(vy(c1, 0) + sqrt(3.0) * vy(c1, 1) + sqrt(5.0) * vy(c1, 3),
            vy(c1, 2) + sqrt(3.0) * vy(c1, 5),
            vy(c1, 4));

        const LocalEdgeVector<2> rightX(vx(c2, 0) - sqrt(3.0) * vx(c2, 1) + sqrt(5.0) * vx(c2, 3),
            vx(c2, 2) - sqrt(3.0) * vx(c2, 5),
            vx(c2, 4));
        const LocalEdgeVector<2> rightY(vy(c2, 0) - sqrt(3.0) * vy(c2, 1) + sqrt(5.0) * vy(c2, 3),
            vy(c2, 2) - sqrt(3.0) * vy(c2, 5),
            vy(c2, 4));
    ...
    void velocityContinuityX(size_t c1, size_t c2, double gamma)
    {
        const LocalEdgeVector<2> topX(
            vx(c1, 0) + sqrt(3.0) * vx(c1, 2) + sqrt(5.0) * vx(c1, 4),
            vx(c1, 1) + sqrt(3.0) * vx(c1, 5),
            vx(c1, 3));
        const LocalEdgeVector<2> bottomX(
            vx(c2, 0) - sqrt(3.0) * vx(c2, 2) + sqrt(5.0) * vx(c2, 4),
            vx(c2, 1) - sqrt(3.0) * vx(c2, 5), vx(c2, 3));

        const LocalEdgeVector<2> topY(
            vy(c1, 0) + sqrt(3.0) * vy(c1, 2) + sqrt(5.0) * vy(c1, 4),
            vy(c1, 1) + sqrt(3.0) * vy(c1, 5),
            vy(c1, 3));
        const LocalEdgeVector<2> bottomY(
            vy(c2, 0) - sqrt(3.0) * vy(c2, 2) + sqrt(5.0) * vy(c2, 4),
            vy(c2, 1) - sqrt(3.0) * vy(c2, 5), vy(c2, 3));
