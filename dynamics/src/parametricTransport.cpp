...
void boundary_lower(const ParametricMesh& smesh, const double dt, CellVector<1>& phiup,
...
void edge_term_Y(const ParametricMesh& smesh, const double dt, CellVector<1>& phiup, const CellVector<1>& phi, // DG0 (1)
