    ...
    for iy in range(ny - 2):
        for ix in range(nx - 2):
            for px in pairs_x:
                if not (
                    (
                        lon_corners[ix, iy + 1][px[0]]
                        == lon_corners[ix + 1, iy + 1][px[1]]
                    )
                    and (
                        lat_corners[ix, iy + 1][px[0]]
                        == lat_corners[ix + 1, iy + 1][px[1]]
                    )
                    and (
                        lon_corners[ix + 1, iy + 1][px[0]]
                        == lon_corners[ix + 2, iy + 1][px[1]]
                    )
                    and (
                        lat_corners[ix + 1, iy + 1][px[0]]
                        == lat_corners[ix + 2, iy + 1][px[1]]
                    )
                ):
            ...
            for py in pairs_y:
                if not (
                    (
                        lon_corners[ix + 1, iy + 2][py[0]]
                        == lon_corners[ix + 1, iy + 1][py[1]]
                    )
                    and (
                        lat_corners[ix + 1, iy + 2][py[0]]
                        == lat_corners[ix + 1, iy + 1][py[1]]
                    )
                    and (
                        lon_corners[ix + 1, iy + 1][py[0]]
                        == lon_corners[ix + 1, iy][py[1]]
                    )
                    and (
                        lat_corners[ix + 1, iy + 1][py[0]]
                        == lat_corners[ix + 1, iy][py[1]]
                    )
                ):
                    print("Error with maching points")
                    return False
