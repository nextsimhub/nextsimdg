...
TEST_CASE("TOPAZOcean test")
{
    ...
    ModelArrayRef<Protected::EXT_SST> sst(
        ModelComponent::getStore());
    ModelArrayRef<Protected::EXT_SSS> sss(
        ModelComponent::getStore());
    ModelArrayRef<Protected::MLD> mld(
        ModelComponent::getStore());
    ModelArrayRef<Protected::OCEAN_U> u(
        ModelComponent::getStore());
    ModelArrayRef<Protected::OCEAN_V> v(
        ModelComponent::getStore());
