...
void SlabOcean::configure()
{
    ...
    getStore().registerArray(Protected::SLAB_QDW, &qdw);
    getStore().registerArray(Protected::SLAB_FDW, &fdw);
    getStore().registerArray(Protected::SLAB_SST, &sstSlab);
    getStore().registerArray(Protected::SLAB_SSS, &sssSlab);
}
