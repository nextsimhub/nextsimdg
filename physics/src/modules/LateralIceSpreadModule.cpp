...
template <>
Module<Nextsim::ILateralIceSpread>::fn Module<Nextsim::ILateralIceSpread>::spf = functionMap.at(HIBLERSPREAD);
template <>
...
template <>
std::string Module<Nextsim::ILateralIceSpread>::moduleName(){    return "Nextsim::ILateralIceSpread";}

template <>
Nextsim::ILateralIceSpread& getImplementation<Nextsim::ILateralIceSpread>()
{
    return getImplTemplate<Nextsim::ILateralIceSpread, LateralIceSpreadModule>();
}
template <>
void setImplementation<Nextsim::ILateralIceSpread>(const std::string& implName)
{
    setImplTemplate<LateralIceSpreadModule>(implName);
}
template <>
std::unique_ptr<Nextsim::ILateralIceSpread> getInstance()
{
