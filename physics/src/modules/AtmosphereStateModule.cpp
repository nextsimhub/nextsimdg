...
template <>
Module<Nextsim::AtmosphereState>::fn Module<Nextsim::AtmosphereState>::spf = functionMap.at(DUMMYATMOSPHERESTATE);
template <>
...
template <>
std::string Module<Nextsim::AtmosphereState>::moduleName(){    return "Nextsim::AtmosphereState";}

template <>
Nextsim::AtmosphereState& getImplementation<Nextsim::AtmosphereState>()
{
    return getImplTemplate<Nextsim::AtmosphereState, AtmosphereStateModule>();
}
template <>
void setImplementation<Nextsim::AtmosphereState>(const std::string& implName)
{
    setImplTemplate<AtmosphereStateModule>(implName);
}
template <>
std::unique_ptr<Nextsim::AtmosphereState> getInstance()
{
