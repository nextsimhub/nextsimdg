...
template <>
std::unique_ptr<Nextsim::IPhysics1d> Module<Nextsim::IPhysics1d>::staticInstance
    = std::move(Module<Nextsim::IPhysics1d>::spf());

template <> std::string Module<Nextsim::IPhysics1d>::moduleName() { return "IPhysics1d"; }

template <> Nextsim::IPhysics1d& getImplementation<Nextsim::IPhysics1d>()
{
    return getImplTemplate<Nextsim::IPhysics1d, IPhysics1dModule>();
}

template <> void setImplementation<Nextsim::IPhysics1d>(const std::string& implName)
{
    setImplTemplate<IPhysics1dModule>(implName);
}

template <> std::unique_ptr<Nextsim::IPhysics1d> getInstance()
{
