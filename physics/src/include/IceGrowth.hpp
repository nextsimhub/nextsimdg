...
private:
    ...
    HField hice0; // Initial ice thickness, m
    ...
    ModelArrayRef<Shared::C_ICE, RW> cice; // Ice concentration [0-1]
    ModelArrayRef<Shared::H_ICE, RW> hice; // Ice thickness (mean over grid cell) [m]
    ModelArrayRef<Shared::H_SNOW, RW> hsnow; // Snow thickness (mean over grid cell) [m]
