...
void setupXiosHandler(Xios* xios_handler, int dim, bool read)
{
    ...
    pio->xiosHandler->createField(fieldId);
    pio->xiosHandler->setFieldOperation(fieldId, "instant");
    pio->xiosHandler->setFieldGridRef(fieldId, formatId("grid", dim));
