...
MPI_TEST_CASE("TestXiosRead_2D", 2)
{
    ...
    Xios xios_handler = pio->getXiosHandler("P0-0T01:30:00", "read_2D", "2023-03-17T17:11:00Z");
    setupXiosHandler(&xios_handler, 2, true);
...
MPI_TEST_CASE("TestXiosRead_3D", 2)
{
    ...
    // FIXME: Implement singleton properly
    Xios xios_handler = pio->getXiosHandler("P0-0T01:30:00", "read_3D", "2023-03-17T17:11:00Z");
    setupXiosHandler(&xios_handler, 3, true);
...
MPI_TEST_CASE("TestXiosWrite_2D", 2)
{
    ...
    // FIXME: Implement singleton properly
    Xios xios_handler = pio->getXiosHandler("P0-0T01:30:00", "write_2D", "2023-03-17T17:11:00Z");
    setupXiosHandler(&xios_handler, 2, false);
...
MPI_TEST_CASE("TestXiosWrite_3D", 2)
{
    ...
    // FIXME: Implement singleton properly
    Xios xios_handler = pio->getXiosHandler("P0-0T01:30:00", "write_3D", "2023-03-17T17:11:00Z");
    setupXiosHandler(&xios_handler, 3, false);
