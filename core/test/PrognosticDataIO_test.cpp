...
// The CMake files uses TRUE and FALSE. Reduce these (and the CMake defaults ON & OFF) to C++
// standard values
#ifndef TRUE
#define TRUE true
#endif
...
TEST_CASE("PrognosticData write test, including DG components")
{
    ...
    ModelArray::setDimension(
        ModelArray::Dimension::YVERTEX, ModelArray::size(ModelArray::Dimension::Y) + 1);
