...
std::map<ModelArray::Dimension, ModelArray::DimensionSpec> ModelArray::definedDimensions = {
    ...
    { ModelArray::Dimension::XCG, { "x_cg", "x_cg", 1, 1, 0 } },
    { ModelArray::Dimension::YCG, { "y_cg", "y_cg", 1, 1, 0 } },
    // The DG components are also included here to store the names
    { ModelArray::Dimension::DG, { "dg_comp", "dg_comp", 1, 1, 0 } },
    { ModelArray::Dimension::DGSTRESS, { "dgstress_comp", "dgstress_comp", 1, 1, 0 } },
