...
template <typename I> typename Module<I>::fn Module<I>::spf;
template <typename I> std::unique_ptr<I> Module<I>::staticInstance;
template <typename I> typename Module<I>::map Module<I>::functionMap;
